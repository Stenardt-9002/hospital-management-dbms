...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.3 on Thu Apr 11 20:42:50 2019
#

import wx
import wx.grid
import Dep2 as Dew
import Employee3 as Emp
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.Bind(wx.EVT_BUTTON, self.Employee, self.button_7)
        # end wxGlade
    ...
    def Employee(self, event):  # wxGlade: MyFrame.<event_handler>
        # print("Event handler 'Employee' not implemented!")
        Emp.initialise()
        event.Skip()
