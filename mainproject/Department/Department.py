...
import wx
from Department import Departmentsql
...
class MyFrame(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.text_ctrl_1 = wx.TextCtrl(self, wx.ID_ANY, " int ")
        self.text_ctrl_1.Bind(wx.EVT_TEXT,self.EVT1)
        # x1 = self.text_ctrl_1.GetValue()

        self.text_ctrl_2 = wx.TextCtrl(self, wx.ID_ANY, " character ")
    ...
    def Onclik(self,e):
        ...
        # z = input(" main pro z ")
        if self.x1==0 or self.x2==0 or tmp==145:
        ...
        # z = input()
        if x == 1:
            yesNoBox = wx.MessageDialog(None, 'THE ID YOU ARE ENTERING IS ALREADY PRESENT '+li_st+'\nPRESS yes to try again and no to stop', 'Question', wx.YES_NO)
