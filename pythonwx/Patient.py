...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.3 on Fri Apr 12 03:51:23 2019
#
...
class MyFrame(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.Bind(wx.EVT_TEXT, self.diagnosed_for, self.text_ctrl_8)
        self.Bind(wx.EVT_BUTTON, self.Button_pressed, self.button_1)
        # end wxGlade

    def __set_properties(self):
        # begin wxGlade: MyFrame.__set_properties
        self.SetTitle("Add Patient")
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        label_3 = wx.StaticText(self, wx.ID_ANY, " P_id")
        ...
        sizer_1.Add(self.radio_btn_4, 0, 0, 0)
        ...
        label_10 = wx.StaticText(self, wx.ID_ANY, "  Diagnosed for")
    ...
    def diagnosed_for(self, event):  # wxGlade: MyFrame.<event_handler>
        # print("Event handler 'diagnosed_for' not implemented!")
        self.diagno_se = event.GetString()
        event.Skip()
    ...
    def Button_pressed(self, event):  # wxGlade: MyFrame.<event_handler>
        ...
        try:
            ...
            print("dreached 8 ")
            self.err_or()
        x = da_techk.date_ver(self.da_te, self.mn_th, self.ye_ar)
        ...
        # contacting sql
        # x12, mlist = Employeesql.getdata(self.fir_st, self.las_t, self.p_id, dob, self.gend, self.b_id, self.de_id)
        x12,mlist = Patientsql.getdata(self.fir_st,self.las_t,self.p_id,dob,self.gend,self.b_id,self.diagno_se)
        ...
        if x12 == -1:
            ...
            if yesNoAnswer == wx.ID_YES:
                ...
                self.close()
        if x==1:
            yesNoBox2 = wx.MessageDialog(None, "Successful", 'Notification', wx.OK)
